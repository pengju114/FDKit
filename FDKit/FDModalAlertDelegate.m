...
@interface FDModalAlertDelegate ()
@property(nonatomic,assign) CFRunLoopRef currentRunloop;

@end


@implementation FDModalAlertDelegate
...
-(void)correctPosition:(UIAlertView *)dialog{
    ...
    CGPoint center = CGPointMake([FDDeviceUtility applicationWidth]*0.5f, [FDDeviceUtility applicationHeight]*0.25f);
